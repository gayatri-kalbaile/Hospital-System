...
<div class="Department_girds_agileits">
	...
	<div class="container">
		<div>
			<center>
			<h1 style="background-color: rgb(237, 233, 227);font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;color: coral;  height:80px;padding: 20px;"> ENT... </h1>
			</center>
		</div>
			...
			<div class="agile_team_grid">	
				...
				<div class="col-md-6">
						...
						<div style="background-color: rgb(63, 216, 214); padding: 10px;
						border: 2px dashed rgb(241, 27, 27);">
							
						
							<p> Abbreviation for ears, nose and throat.</p>
							<p> Surgery is a branch of medicine that is concerned with the treatment of injuries , diseases, and other disorders by </p>
							<p>manual and instrumental means surgery...</p>
							<br>
							ENT's can do surgery and treat many different medical conditions<br>
							An ear condition, such as an infection, hearing loss, or trouble with balance
							<span> Throat problems like tonsillitis, difficulty swallowing, and voice issues....
							<br>

							Some areas of your head are treated by other kinds of doctors. For example, neurologists<br>
							deal with problems with your brain or nervous system, and ophthalmologists care for your eyes
						</span>
						</div>
				</div>
			</div>
